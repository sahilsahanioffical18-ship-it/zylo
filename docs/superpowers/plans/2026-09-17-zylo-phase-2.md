...
**Tech Stack:** socket.io 4 (server) and socket.io-client 4 (web), Express 5.2, pg 8, Postgres 16, `node:test`, Next.js 16.3.5, React 19.2.8, Tailwind v4, shadcn/ui (radix base, nova preset), Lucide, sonner, `@clerk/express` 2.1.67, `@clerk/nextjs` 7.9.2.
